...
param sqlConnectionString = 'Server=tcp:sql-adt-platform-dev.database.windows.net,1433;Initial Catalog=ReferenceProjectsDb;Persist Security Info=False;User ID=sqladmin;Password=7JRap3o03iue2F8;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;'
